...
namespace CEC09
{
	enum CEC09_TYPE{TUF1,TUF2,TUF3,TUF4,TUF5,TUF6,TUF7,TUF8,TUF9,TUF10,TCF1,TCF2,TCF3,TCF4,TCF5,TCF6,TCF7,TCF8,TCF9,TCF10};
	CEC09_TYPE getCEC09Type(const char* instance);
	void CEC09_Vars_Allocate(double *lowBound,double *uppBound,const unsigned int nvar,const CEC09_TYPE type);
